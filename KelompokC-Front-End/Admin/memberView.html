	...
	<div class="container-fluid p-5 mt-5">
		<div class="table-wrapper shadow-lg">
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					<tr href="#cekAnggota" class="view" data-toggle="modal" rel="tooltip"
						title="Klik di  sini untuk melihat profil" data-placement="top">
						<td>
							<span class="custom-checkbox">
						...
						<td>1</td>
						<td><img class="gambar" src="./assets/img/default-avatar.png" alt="" /></td>
