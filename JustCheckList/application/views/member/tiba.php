							...
							<tr>
								...
								<?php } else if ($k->status == 'ditolak') { ?>
									...
									<td>
										...
										<a href="#hapusAnggota-<?= $k->id ?>" class="konfirmasi" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Hapus">&#xE872;</i> </a>
									</td>
								<?php } else { ?>
...
$id = 1;
foreach ($keberangkatan->result() as $k) : ?>
	<div id="hapusAnggota-<?= $k->id ?>" class="modal fade">
		<div class="modal-dialog" style="max-width:400px;">
			<div class="modal-content">
				<form action="<?= base_url('home/hapustiba') ?>?id=<?= $k->id ?>" method="post">
					...
					<div class="modal-footer">
						...
						<button type="submit" class="btn btn-danger" name="tolak" value="<?= $k->id ?>">Hapus</button>
					</div>
				</form>
			</div>
		</div>
