                            ...
                            <form class="p-2">
                                ...
                                <div class="row">
                                    <div class="col-md-4 pr-1">
                                        <div class="form-group">
                                            <label>Negara</label>
                                            <input type="text" class="form-control" placeholder="Agama" value="Indonesia" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 pr-1">
                                        <div class="form-group">
                                            <label>No Hp/Telp</label>
                                            <input type="number" class="form-control" placeholder="No Hp/Telp" value="081264563223" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 pr-1">
                                        <div class="form-group">
                    ...
                    <div class="card card-user">
                        ...
                        <div class="card-body">
                            <div class="author">
                                ...
                                <a href="<?php echo base_url() ?>index.php/website/cek_profileAdmin">
