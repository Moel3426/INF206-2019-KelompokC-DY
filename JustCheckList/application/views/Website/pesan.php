          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink1">
                ...
                <a class="dropdown-item" href="<?php echo base_url() ?>index.php/website/cek-profileAdmin">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <a href="<?php echo base_url() ?>index.php/website/inbox" class="btn btn-success btn-user btn-block btn-round">
                          Konfirmasi
                        </a>
                      </div>
                      <div class="col-md-6">
                        <a href="<?php echo base_url() ?>index.php/website/inbox" class="btn btn-danger btn-user btn-block btn-round">
                          Tolak
                        </a>
                      </div>
                    </div>
                    <a href="<?php echo base_url() ?>index.php/website/inbox" class="btn btn-warning btn-user btn-block btn-round">
                      Kembali
                    </a>
                  </form>
                  <hr>
