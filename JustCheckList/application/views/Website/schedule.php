          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink1">
                ...
                <a class="dropdown-item" href="<?php echo base_url() ?>index.php/website/cek_profile">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user">
                    ...
                    <a href="<?php echo base_url() ?>index.php/website/preview" class="btn btn-primary btn-user btn-block btn-round">
                      Submit
                    </a>
                  </form>
                  <hr>
