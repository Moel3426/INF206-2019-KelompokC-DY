		...
		<nav class="navbar navbar-expand-lg bg-dark fixed-top navbar-dark">
			<div class="container-fluid">
				<div class="navbar-translate">
					<a class="navbar-brand " href="<?php echo base_url() ?>index.php/website/homeAdmin" rel="tooltip" title="Home" data-placement="bottom">
						JUST CHECK LIST
					</a>
				...
				<div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="<?php echo base_url() ?>assets/img/1.jpg">
					<ul class="navbar-nav">
						<li class="nav-item">
							<a class="nav-link" href="<?php echo base_url() ?>index.php/website/adminDashboard" onclick="scrollToDownload()">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink1">
								...
								<a class="dropdown-item" href="<?php echo base_url() ?>index.php/website/memberAdmin">
						...
						<li class="nav-item">
							<a class="nav-link" href="<?php echo base_url() ?>index.php/website/inbox" onclick="scrollToDownload()">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink1">
								...
								<a class="dropdown-item" href="<?php echo base_url() ?>index.php/website/cek_profileAdmin">
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					<tr>
						...
						<td>1</td>
						<td href="#cekAnggota" class="view" data-toggle="modal"><img class="gambar" src="<?php echo base_url() ?>assets/img/default-avatar.png" alt="" rel="tooltip" title="Klik di  sini untuk melihat profil" data-placement="top" /></td>
						<td>Maulana Ihsan Ahmad</td>
						<td>maulanaihsanpress@gmail.com</td>
						<td>Tibang, Syiah Kuala Banda Aceh</td>
						<td>081264563223</td>
						<td> <a href="#hapusAnggota" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Hapus">&#xE872;</i></a>
						</td>
							...
							<div class="card card-user">
								...
								<div class="card-body">
									<div class="author">
										...
										<h5 class="title text-primary">Maulana Ihsan Ahmad</h5>
										<div>
											<a href="<?php echo base_url() ?>index.php/website/memberView">
