		...
		<nav class="navbar navbar-expand-lg bg-dark fixed-top navbar-dark">
			<div class="container-fluid">
				<div class="navbar-translate">
					<a class="navbar-brand " href="<?php echo base_url() ?>/website/homeAdmin" rel="tooltip" title="Home" data-placement="bottom">
						JUST CHECK LIST
					</a>
					...
					<ul class="navbar-nav">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink1">
								...
								<a class="dropdown-item" href="<?php echo base_url(''); ?>website/memberAdmin">
						...
						<li class="nav-item">
							<a class="nav-link" href="<?php echo base_url(''); ?>website/inbox" onclick="scrollToDownload()">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink1">
								...
								<a class="dropdown-item" href="<?php echo base_url(''); ?>website/cek_profileAdmin">
			...
			<div class="col-xl-3 col-md-6 mb-4">
				<div class="card card-nav-tabs text-center p-1">
					...
					<div class="card-body">
						...
						<a href="<?php echo base_url('website/pesan'); ?>" class="btn btn-primary">Check</a>
