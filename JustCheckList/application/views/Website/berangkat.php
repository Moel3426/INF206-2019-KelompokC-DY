          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink1">
                ...
                <a class="dropdown-item" href="<?php echo base_url() ?>website/cek_profile">
                  <i class="now-ui-icons users_single-02"></i> Check Profile
                </a>
                <a class="dropdown-item" href="<?php echo base_url() ?>website/">
                ...
                <div class="p-5">
                  ...
                  <form class="user">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="idKapal" aria-describedby="emailHelp" placeholder="Masukkan ID Kapal ..." required>
                    </div>
                    <div class="form-group">
                      <label for="">Keberangkatan</label>
                      <input type="text" class="form-control date-picker" placeholder="Masukkan Jadwal..." data-datepicker-color="primary" required>
                    </div>
                    <div class="form-group">
                      ...
                      <table class="table table-striped table-hover">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <a href="#hapusAnggota" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                            </td>
                          </tr>
                          <tr>
                            <td>2</td>
                    ...
                    <a href="<?php echo base_url() ?>website/preview" class="btn btn-primary btn-user btn-block btn-round">
                      Submit
                    </a>
                  </form>
                  <hr>
