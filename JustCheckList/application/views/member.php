		...
		<nav class="navbar navbar-expand-lg bg-dark fixed-top navbar-dark">
			<div class="container-fluid">
				<div class="navbar-translate">
					<a class="navbar-brand " href="<?php echo base_url() ?>home" rel="tooltip" title="Home" data-placement="bottom">
						JUST CHECK LIST
					</a>
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td>5</td>
						<td href="#cekAnggota" class="view" data-toggle="modal"><img class="gambar"
								src=".<?php echo base_url() ?>/img/default-avatar.png" alt="" rel="tooltip"
								title="Klik di  sini untuk melihat profil" data-placement="top" /></td>
						<td>Martin Blank</td>
