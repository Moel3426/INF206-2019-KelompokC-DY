                  ...
                  <form class="user">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="idKapal"
                        aria-describedby="emailHelp" placeholder="Masukkan ID Kapal ..." required>
                    </div>
                    <div class="form-group">
                    ...
                    <a href="<?php echo base_url() ?>indexphp/landing/preview" class="btn btn-primary btn-user btn-block btn-round">
                      Submit
                    </a>
                  </form>
                  <hr>
