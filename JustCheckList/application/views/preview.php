    ...
    <nav class="navbar navbar-expand-lg bg-dark fixed-top navbar-dark">
      <div class="container-fluid">
        <div class="navbar-translate">
          <a class="navbar-brand " href="<?php echo base_url() ?>indexphp/landing/home" rel="tooltip" title="Home" data-placement="bottom">
            JUST CHECK LIST
          </a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="<?php echo base_url() ?>./assets/img/1.jpg">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url() ?>indexphp/landing/dashboard" onclick="scrollToDownload()">
                <i class="now-ui-icons shopping_shop"></i>
                <p>Dashboard</p>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url() ?>indexphp/landing/member" onclick="scrollToDownload()">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink1">
                <a class="dropdown-item" href="<?php echo base_url() ?>indexphp/landing/berangkat">
                  <i class="now-ui-icons files_box"></i> Keberangkatan
                </a>
                <a class="dropdown-item" href="<?php echo base_url() ?>indexphp/landing/tiba">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url() ?>indexphp/landing/history" onclick="scrollToDownload()">
            ...
            <li class="nav-item dropdown">
              <a href="#" class="nav-link dropdown-toggle" id="navbarDropdownMenuLink1" data-toggle="dropdown">
                <img class="rounded-circle" src="<?php echo base_url() ?>assets/img/default-avatar.png" width="30px" height="30px" alt=""
                  srcset="">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink1">
                ...
                <a class="dropdown-item" href="<?php echo base_url() ?>indexphp/landing/cek_profile">
                  <i class="now-ui-icons users_single-02"></i> Check Profile
                </a>
                <a class="dropdown-item" href="<?php echo base_url() ?>indexphp/landing/">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user">
                    ...
                    <a href="<?php echo base_url() ?>indexphp/landing/history" class="btn btn-success btn-user btn-block btn-round">
                      Ajukan
                      <a href="<?php echo base_url() ?>indexphp/landing/schedule" class="btn btn-danger btn-user btn-block btn-round">
                        Kembali
                      </a>
                  </form>
                  <hr>
